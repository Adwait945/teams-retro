...
> **Model-aware output rule**: Declare your context window at the top of every DEV prompt using `[MODEL: 200K]`, `[MODEL: 1M]`, or `[MODEL: 2M]`. This controls whether the agent chunks large file edits or writes complete files per turn. See Q21 in MAWv5.md for full rationale.
